...
export const ph = [
  4.3, 2.2, 5.3, 2.4, 6.5, 6.7, 5.7, 5.0, 7.5, 8.3, 7.7, 4.5, 5.5, 6.7, 7.7, 5.7, 8.8, 9.6, 7.8,
  6.5, 7.6, 8.4, 7.6, 7.2, 6.5, 6.1, 5.9, 5.7, 5.0, 4.9, 7.9, 5, 2.6, 3.1, 3.9, 1.2, 3.2, 4.1, 5,
  4.5, 4.1, 2.3, 2.4, 5, 3.1, 4.9, 1.7
];
